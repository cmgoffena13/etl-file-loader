...
class TestEmailNotifications:
    ...
    def test_email_notification_on_validation_error(
        self, mock_email_notify, create_csv_file, test_processor
    ):
...
class TestSlackNotifications:
    ...
    def test_slack_notification_on_processing_failures(
        self, mock_slack_notify, create_csv_file, test_processor
    ):
    ...
    def test_slack_notification_on_no_source_found(
        self, mock_slack_notify, session_temp_dir, test_processor
    ):
    ...
    def test_slack_notification_not_sent_on_success(
        self, mock_slack_notify, test_processor
    ):
...
class TestNotificationIntegration:
    """Test integration of email and Slack notifications together."""
